...
public class CleaningActivity extends AppCompatActivity {
    private TextView mon,tue,wed,thu,fri,sat,sun,nine,ten,eleven,twelve,thir,four,fif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef=mbase.getReference("Users").child(mAuth.getUid()).child("Cleaning schedule").child("Day");
        nRef=mbase.getReference("Users").child(mAuth.getUid()).child("Cleaning schedule").child("Time");
        pRef=mbase.getReference("Users").child(mAuth.getUid()).child("Cleaning schedule");
        ...
        Schedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(CleaningActivity.this, "Interior cleaning schedule has been saved",
                        Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CleaningActivity.this, SubscriptionActivity.class));
            }
        });
