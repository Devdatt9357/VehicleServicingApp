...
public class VerifyActivity extends AppCompatActivity {
    ...
    private TextView signup,terms,customer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        terms=findViewById(R.id.verify_terms);
        tv3=findViewById(R.id.verify_ne8);
        tv4=findViewById(R.id.verify_ne3);
        customer=findViewById(R.id.verify_customer);
